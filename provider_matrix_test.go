...
func TestProviderMetadataForAllChannels(t *testing.T) {
	providers := []struct {
		...
		{"memory", func() (providerMetadata, error) { return memory.New("memory"), nil }, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetGroup, uvim.TargetChannel, uvim.TargetConversation}},
		...
		}, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetGroup, uvim.TargetConversation}},
		...
		{"dingtalk", func() (providerMetadata, error) { return dingtalk.New(dingtalk.Config{BaseURL: "http://127.0.0.1"}) }, true, true, true, false, true, 0, []string{uvim.TargetUser, uvim.TargetGroup}},
		...
		}, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetChannel, uvim.TargetConversation}},
		...
		}, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetChannel}},
		{"line", func() (providerMetadata, error) { return line.New(line.Config{BaseURL: "http://127.0.0.1"}) }, true, true, true, true, true, 1, []string{uvim.TargetUser, uvim.TargetGroup, uvim.TargetConversation}},
		...
		}, true, false, true, true, false, 0, []string{uvim.TargetUser}},
		...
		}, true, true, true, true, true, 0, []string{uvim.TargetConversation}},
		{"onebot", func() (providerMetadata, error) { return onebot.New(onebot.Config{BaseURL: "http://127.0.0.1"}) }, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetGroup}},
		{"qq", func() (providerMetadata, error) { return qq.New(qq.Config{BaseURL: "http://127.0.0.1"}) }, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetGroup}},
		{"qqguild", func() (providerMetadata, error) { return qqguild.New(qqguild.Config{BaseURL: "http://127.0.0.1"}) }, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetGroup, uvim.TargetChannel}},
		...
		}, true, true, true, true, true, 0, []string{uvim.TargetUser, uvim.TargetGroup}},
	...
	for _, item := range providers {
		t.Run(item.name, func(t *testing.T) {
			...
			if caps.ReplyMaxUses != item.replyMaxUses {
				t.Fatalf("reply max uses = %d, want %d", caps.ReplyMaxUses, item.replyMaxUses)
			}
